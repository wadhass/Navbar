...
const Footer = () => {
    ...
    return (
        <footer className="bg-gray-900 text-gray-300 flex flex-col shadow-md border-t border-gray-500  
        items-center justify-center h-auto sm:h-[20vh] gap-4 py-8 z-0">
